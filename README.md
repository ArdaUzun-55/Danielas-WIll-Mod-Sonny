...
- Zone 6 Shotul Shelf is now optional and isnt required to go to Kshatriyana and Utopia. Daniela got nerved (Her Super Heal got removed). (12.11.2022)
 ...
 1.3 : Big Update featuring:

New Side Stories to all zones;

->Sonny 2017 Zones

->new Mechanics

->almost every mechanic from Sonny 2017 i now available in Sonny 2

, for example Auras like Chromascreen, Black Mirror, Dark Absorb, ETC.

-> Aoe doesnt work with all new mechanics, because I am lazy, but aoe mechanics by enemies always work. So its just only for Sonny, sayable i guess.

->Kshatriyana shortened and rewritten, new script and new structure, no repition, 1 returning enemy from Sonny 1 Danieals WIll Mod Zone 4.

->Side Storys now dont share the progress with the main story anymore so you cant really farm one fight, in return the daily limit got removed. In Side stories you only gain items not EXP.

-> Sprites from Sonny 2017 added.

-> Fundas class got a bit of a change.

-> Danielas class got a bit of a change

-> Every Zone now got a change, not every enemy but there are more unique things now, including different stages.

-> You need to start a new save file

-03,11,2023 = made some changes to Ceyda and Daniela (1st fight); They now have 100% Stun Resist and I also made some other changes to them.

-0.8.11.2023 = Danielas ultimate strengthened

-28.03.2024 = FIXED A MAJOR BUG REGARDING SIDE STORIES! THE STORY PROGRESSES EVEN IF YOU DO "NEXT BATTLE (RED)". THIS WAS FIXED

-29.03.2024 = Nerfed rejuvenation cooldown

-01.04.2024 = Balance changes + ZPCI class buff

-02.04.2024 = Nerfed Funda and Daniela, fixed a bug where a specific theme plays even though it shouldnt

-02.04.2024 = Buffed Praetors Supercannon (ZPCI Class)

-04.04.2024 = Changed Baroness Maries behavior

-04.04.2024 = Nerfed Rishabs buffs (dispellable).

-10.04.2024 = buffed cremate changed Mana Shock a bit, it now silences (increasing the targets next abilities cooldown by 2 turns)

-13.04.2024 = Danielas Last Cosmic nukes description fixed

-18.04.2024 = Fixed Dr KLima having the wrong attack (Area forbid), Added a new mechanic called Bleed and Frostbitten! PLease report bugs.

-18.04.2024 = ZPCI Pyrotech had the wrong audios when she attacks. PLease report bugs.

-19.04.2024 = Added a text file which says what the abilities of the allies are

-22.04.2024 = fixed hot heal being dispelled by dux heal, added blackflame equipment "Void" into z1 & 2

-22.04.2024 = fixed a bug where bleed / frostbite is applied directly, also fixed a buff icon

-23.04.2024 = Blackflame armor added to all zones before Utopia (not including shotul shelfs) some are buyable some are earned by fighting

-08.05.2024 = Fixed a chroma screen bug regarding ice attacks, Fixed void staff incorrectly showing the sniper instead

THIS IS STILL A BETA SO I DONT GUARANTEE THAT EVERYTHING WORKS THERE, MAY BE BUGS OR ANY OTHER THING SO REPORT IT PER DISCORD OR BETTER: IN THE ISSUES TAB NEAR <> Code -> https://i.imgur.com/JyHhM4f.png
...
The up to date code can be found in github! Note: The current code contains many new mechanics and it is still in test phase and dont copy everything because the DOTTICKERARRAY is different than the original one.

I will try to update it every 2nd day starting from today 08.05.2024
