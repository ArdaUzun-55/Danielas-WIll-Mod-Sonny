...
updateDoll = function()
{
   ...
   for(h in dollPartsArray)
   {
      ...
      if(h == 12 || h == 13)
      {
         this[dollPartsArray[h]].attachMovie("M_" + dollPartsCores2[h] + "_" + _root["KRINITEM" + _root.Krin["equipArray" + _root.Krin.MenuPlayerSelect][dollPartsCores[h]]].looks,"inner",0);
      }
   }
