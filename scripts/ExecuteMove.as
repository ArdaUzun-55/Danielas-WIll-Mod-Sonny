...
lifeBarUpdate = function(PWLC)
{
   ...
   else if(ghjul.STANCE < ghjul.STANCEMAX)
   {
      ...
      else if(ghjul.FROSTBITTEN < ghjul.FROSTBITTENMAX)
      {
         _root["p" + PWLC + "BAR"].inner.focusMax20 = "Stance:" + ghjul.STANCE + "/" + ghjul.FROSTBITTEN;
      }
   }
   else if(ghjul.BLEED < ghjul.BLEEDMAX)
   {
      _root["p" + PWLC + "BAR"].inner.focusMax20 = "Bleed:" + ghjul.BLEED;
      if(ghjul.FROSTBITTEN < ghjul.FROSTBITTENMAX)
      {
         _root["p" + PWLC + "BAR"].inner.focusMax20 = "Bleed:" + ghjul.BLEED + "/" + ghjul.FROSTBITTEN;
      }
   }
   else if(ghjul.FROSTBITTEN < ghjul.FROSTBITTENMAX)
   {
      _root["p" + PWLC + "BAR"].inner.focusMax20 = "Frostbitten:" + ghjul.FROSTBITTEN;
   }
   else
   {
