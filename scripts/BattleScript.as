                        ...
                        while(mAry2[45] > JI)
                        {
                           ...
                           else
                           {
                              ...
                              while(owegwe < 3)
                              {
                                 ...
                                 {
                                    _root.krinBoltMake(_root.BATTLESCREEN[mCaster2],_root.BATTLESCREEN["player" + _root["playerKrin" + (mTarget.teamSide + owegwe * 2)].playerID],mAry1[11],mAry1[12],mAry1[13],mAry2[45]);
                                 }
                                 owegwe++;
                              }
                           }
