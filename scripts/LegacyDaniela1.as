      ...
      else
      {
         ...
         if(IDKT.SSWITCH == 0)
         {
            if(IDKC.playerID == _root.Krin.playerNumber)
            {
               ...
               {
                  var _loc6_ = IDKM2[0];
                  var _loc7_ = _root.DamageOutputKrinFinal;
                  var _loc8_ = _loc6_ == elementMainArray[0];
                  if(_loc8_)
                  {
                     _root.updateTopPhysicalDamage(_loc7_);
                  }
                  else
                  {
                     _root.updateTopElementalDamage(_loc7_);
                  }
               }
            }
            MULTI = 0;
            ...
            if(IDKT.LIFEN <= 0 && IDKT.FOCUSU != 101)
            {
               IDKT.LIFEN = 0;
               IDKT.FOCUSN = 0;
            }
...
function ModifyHP(Damage, element, ignoreDefense, mCaster, mTarget)
{
   ...
   if(num3 > 0)
   {
      ...
      else
      {
         ...
         if(mTarget.LIFEN < 0 && mTarget.FOCUSU == 101)
         {
            mTarget.LIFEN = 0;
            mTarget.FOCUSN = 0;
         ...
         if(mTarget.LIFEN > 0 && mTarget.FOCUSU == 101 && Stun == 1)
         {
...
function precheckBuff(mCaster, mTarget, mAry2, mAry1)
{
   ...
   if(mAry2[102] != 0)
   {
      if(mAry2[102] == mTarget.abilityhistoryIDKM[10])
      {
         mAry1[9] *= 0;
      }
   }
...
function buffTicker(ukcb3)
{
   ...
   if(ukcb3.LIFEN < 0 && ukcb3.FOCUSU == 101)
   {
      ukcb3.LIFEN = 0;
      ukcb3.FOCUSN = 0;
   ...
   if(ukcb3.LIFEN > 0 && ukcb3.FOCUSU == 101 && Stun == 1)
   {
...
function changeForm(changeTo, p_id)
{
   ...
   {
      _root.BATTLESCREEN["player" + p_id].inner.gotoAndPlay("stun");
   }
}
...
_root.hackMove[9] = 5;
_root.hackMove[17] = krinABC1[0] + "160%" + krinABC2[0] + "5" + krinABC3[0];
addNewMove("Smash",0,1,0,15,0,6,8,1,"Melee","0xFF0000","Attack","BOOM_SLASHORANGE","Full Damage",1,0,0,"Hit3");
_root.hackMove[2] = 2;
_root.hackMove[9] = 8;
_root.hackMove[17] = krinABC1[0] + "200%" + krinABC2[0] + "8" + krinABC3[0];
addNewMove("Smash",0,1,0,15,0,6,8,1,"Melee","0xFF0000","Attack","BOOM_SLASHORANGE","Full Damage",1,0,0,"Hit3");
_root.hackMove[2] = 2.4;
_root.hackMove[9] = 15;
_root.hackMove[17] = krinABC1[0] + "240%" + krinABC2[0] + "15" + krinABC3[0];
addNewMove("Smash",0,1,0,15,0,6,8,1,"Melee","0xFF0000","Attack","BOOM_SLASHORANGE","Full Damage",1,0,0,"Hit3");
_root.hackMove[2] = 2.45;
_root.hackMove[9] = 20;
_root.hackMove[17] = krinABC1[0] + "245%" + krinABC2[0] + "20" + krinABC3[0];
addNewMove("Smash",0,1,0,15,0,6,8,1,"Melee","0xFF0000","Attack","BOOM_SLASHORANGE","Full Damage",1,0,0,"Hit3");
...
_root.hackMove[7] = 25;
_root.hackMove[8] = 1.5;
_root.hackMove[9] = 290;
_root.hackMove[17] = krinABC1[15] + _root.hackMove[9] + krinABC2[15] + "30%" + krinABC3[15];
addNewMove("Coup De Grace",0,1,0,35,0,8,1,0.7000000000000001,"Melee","0xFFCC00","Attack","BOOM_SLASHRED","Full Damage",1,0,15,"Hit3");
_root.hackMove[2] = 2.2;
_root.hackMove[7] = 25;
_root.hackMove[8] = 1.5;
_root.hackMove[9] = 340;
_root.hackMove[17] = krinABC1[15] + _root.hackMove[9] + krinABC2[15] + "30%" + krinABC3[15];
...
_root.hackMove[45] = 3;
_root.hackMove[17] = krinABC3[80] + _root.hackMove[6] * 100 + krinABC2[80];
addNewMove("Aeolian Edge",0,1,0,-5,0,0,1,2,"Melee","0xFF66FF","Attack","BOOM_RED","Full Damage",1,0,130,"Spinningedge");
_root.hackMove[0] = "Physical";
...
_root.hackMove[103] = "Gust Slash";
_root.hackMove[17] = krinABC1[130] + _root.hackMove[6] * 100 + krinABC2[130];
addNewMove("Aeolian Edge",0,1,0,-15,0,0,1,2,"Melee","0xFF66FF","Attack","BOOM_RED","Full Damage",1,0,130,"Spinningedge");
_root.hackMove[0] = "Physical";
_root.hackMove[6] = 3.4;
_root.hackMove[103] = "Gust Slash";
_root.hackMove[17] = krinABC1[130] + _root.hackMove[6] * 100 + krinABC2[130];
...
_root.hackMove2[17] = 1;
_root.hackMove2[20] = -1;
_root.hackMove2[25] = _root.KrinLang[KLangChoosen].AUX1[1];
...
addMoveForPlayer = function(txvd)
{
   ...
   else
   {
      ...
      if(mAry5[0] == "Fire IV")
      {
         ...
         while(f < _root.maxBuffLimit)
         {
            if(rovnrevbnr.FOCUSN < mAry5[5] || rovnrevbnr.BUFFARRAYK[f].buffId == "FIREI" && rovnrevbnr.BUFFARRAYK[f].CD != 0)
            {
               checkPassforKrinMove = true;
               break;
            }
      ...
      if(mAry5[0] == "Huton")
      {
         ...
         while(f < _root.maxBuffLimit)
         {
            if(rovnrevbnr.BUFFARRAYK[f].buffId == "DUDRA6" && rovnrevbnr.BUFFARRAYK[f].CD != 0)
            {
               checkPassforKrinMove = true;
               break;
            }
      ...
      if(mAry5[0] == "Raiton")
      {
         ...
         while(f < _root.maxBuffLimit)
         {
            if(rovnrevbnr.BUFFARRAYK[f].buffId == "DUDRA2" && rovnrevbnr.BUFFARRAYK[f].CD != 0)
            {
               checkPassforKrinMove = true;
               break;
            }
      ...
      if(mAry5[0] == "Katon")
      {
         ...
         while(f < _root.maxBuffLimit)
         {
            if(rovnrevbnr.BUFFARRAYK[f].buffId == "DUDRA3" && rovnrevbnr.BUFFARRAYK[f].CD != 0)
            {
               checkPassforKrinMove = true;
               break;
            }
      ...
      if(mAry5[0] == "Doton")
      {
         ...
         while(f < _root.maxBuffLimit)
         {
            if(rovnrevbnr.BUFFARRAYK[f].buffId == "DUDRA5" && rovnrevbnr.BUFFARRAYK[f].CD != 0)
            {
               checkPassforKrinMove = true;
               break;
            }
      ...
      if(mAry5[0] == "Suiton")
      {
         ...
         while(f < _root.maxBuffLimit)
         {
            if(rovnrevbnr.BUFFARRAYK[f].buffId == "DUDRA8" && rovnrevbnr.BUFFARRAYK[f].CD != 0)
            {
               checkPassforKrinMove = true;
               break;
            }
      ...
      if(mAry5[0] == "Blizzard IV" || mAry5[0] == "Freeze")
      {
         ...
         while(f < _root.maxBuffLimit)
         {
            if(rovnrevbnr.FOCUSN < mAry5[5] || rovnrevbnr.BUFFARRAYK[f].buffId == "BLIZZARDI" && rovnrevbnr.BUFFARRAYK[f].CD != 0)
            {
               checkPassforKrinMove = true;
               break;
            }
...
jesivie.movesA = [8,68,5,69,38];
jesivie.movesD = [17,30];
...
jesivie.movesA = [42,81,57,69,508];
...
jesivie.movesA = [56,56,69,62,9,507];
jesivie.movesD = [51];
jesivie.agressionArray = [50,90,60,40];
jesivie.PER = [25,25,25,25,25,25,25,25];
jesivie.DEF = [25,25,25,25,25,25,25,25];
...
jesivie.movesA = [79,79,96,99,104,69,508,508,580,581];
jesivie.movesD = [31];
jesivie.agressionArray = [50,90,60,40];
jesivie.PER = [25,25,25,25,25,25,25,25];
jesivie.DEF = [25,25,25,25,25,25,25,25];
...
jesivie.movesA = [1627,523,1275,1628];
jesivie.movesD = [512,511,1274];
...
jesivie.voiceHit = ["ShamanHit1","ShamanHit2","ShamanHit1"];
jesivie.voiceDie = "ShamanDie";
createNewUnitKrin("Dokebi the Striker",60,8,8,8,8,8,8,6,200);
...
jesivie.movesA = [5,501,505,81,500,4,4,5,1324];
...
Krin.SpeedUP = 50;
Krin.FocusUP = 10;
createNewItemKrin("Gunslinger-Feet",6,"Rare",4,15,2000);
gghhjjuu.looks = "FINAL2";
allClearKrinItem();
